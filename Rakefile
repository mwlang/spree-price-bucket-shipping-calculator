...
desc 'Generate documentation for the price_bucket_rate_shipping extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PriceBucketShippingRateExtension'
...
desc 'Test the price_bucket_shipping_rate extension.'
